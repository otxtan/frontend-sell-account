...
const CustomerManager = () => {
    ...
    const AddElement = () => {
        ...
        const handleChangeFormCustomer = (e) => {
        ...
        const handleCreateOptionRole = async (inputValue) => {
        ...
        return (
            <form onSubmit={handleSubmitCustomer} className='px-auto text-white w-3/4 mx-20'>
                <div className="grid grid-cols-2 gap-4 my-2">
                    ...
                    <input className='bg-gray-500 rounded-md p-2' type="text" name="username" value={FormDataCustomer?.name} onChange={handleChangeFormCustomer} />
                </div>
                <div className="grid grid-cols-2 gap-4 my-2">
                    <label>
                        password:
                    </label>
                    <input className='bg-gray-500 rounded-md p-2' type="text" name="password" value={FormDataCustomer?.description} onChange={handleChangeFormCustomer} />
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 my-2">
                    ...
                    <input className='bg-gray-500 rounded-md p-2' type="text" name="full_name" value={FormDataCustomer?.full_name} onChange={handleChangeFormCustomer} />
                </div>
                <div className="grid grid-cols-2 gap-4 my-2">
                    <label>
                        address:
                    </label>
                    <input className='bg-gray-500 rounded-md p-2' type="text" name="address" value={FormDataCustomer?.address} onChange={handleChangeFormCustomer} />
                </div>
                <div className="grid grid-cols-2 gap-4 my-2">
                    <label>
                        phone_number:
                    </label>
                    <input className='bg-gray-500 rounded-md p-2' type="text" name="phone_number" value={FormDataCustomer?.phone_number} onChange={handleChangeFormCustomer} />
                </div>
                <div className="grid grid-cols-2 gap-4 my-2">
                    <label>
                        email_address:
                    </label>
                    <input className='bg-gray-500 rounded-md p-2' type="text" name="email_address" value={FormDataCustomer?.email_address} onChange={handleChangeFormCustomer} />
                </div>
                {/* <div className="grid grid-cols-2 gap-4 my-2">
                    <label>
                        roleId:
                    </label>
                    <input className='bg-gray-500 rounded-md p-2' type="text" name="roleId" value={FormDataCustomer?.content} onChange={handleChangeFormCustomer} />
                </div> */}
                <div className="grid grid-cols-2 gap-4 my-2">
                    <label>
                        Role:
                    </label>
                    <SelectCustom options={Roles} onChange={handleSelectChangeRole} onCreateOption={handleCreateOptionRole} />
        ...
        return (
            <form onSubmit={handleSubmitCustomer} className='px-auto text-white w-3/4 mx-20'>
                <div className="grid grid-cols-2 gap-4 my-2">
                    ...
                    <input className='bg-gray-500 rounded-md p-2' type="text" name="username" value={FormDataCustomer?.username} onChange={handleChangeFormCustomer} />
                </div>
                <div className="grid grid-cols-2 gap-4 my-2">
                    <label>
                        password:
                    </label>
                    <input className='bg-gray-500 rounded-md p-2' type="text" name="password" value={FormDataCustomer?.password} onChange={handleChangeFormCustomer} />
                </div>
                <div className="grid grid-cols-2 gap-4 my-2">
                    <label>
                        full_name:
